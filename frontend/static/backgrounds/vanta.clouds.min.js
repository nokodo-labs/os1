	...
	(() => {
		...
		s.VantaBase = class {
			constructor(e = {}) {
				...
				;(h('resize', this.resize),
					...
					this.options.gyroControls && h('deviceorientation', this.windowGyroWrapper))
			}
			setOptions(e = {}) {
		...
		class c extends a {
			...
			initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
				...
				n && (this.uniforms.iTex = { type: 't', value: new h.TextureLoader().load(n) })
				const o = new h.Mesh(new h.PlaneGeometry(2, 2), i)
				;(this.scene.add(o), (this.camera = new h.Camera()), (this.camera.position.z = 1))
			}
			updateUniforms() {
				const e = {}
				let t, i
