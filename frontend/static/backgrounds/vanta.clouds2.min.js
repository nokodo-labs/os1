!(function (e, t) {
	...
	(() => {
		...
		let o = (s && window.THREE) || {}
		s && !window.VANTA && (window.VANTA = {})
		const n = (s && window.VANTA) || {}
		...
		n.VantaBase = class {
			...
			initThree() {
				o.WebGLRenderer
					? ((this.renderer = new o.WebGLRenderer({ alpha: !0, antialias: !0 })),
		...
		class l extends h {
			...
			initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
				...
				const i = new a.ShaderMaterial({
					...
					s = this.options.texturePath
				s && (this.uniforms.iTex = { type: 't', value: new a.TextureLoader().load(s) })
				const o = new a.Mesh(new a.PlaneGeometry(2, 2), i)
				;(this.scene.add(o), (this.camera = new a.Camera()), (this.camera.position.z = 1))
			}
			updateUniforms() {
				const e = {}
				let t, i
		...
		class u extends l {}
		const d = n.register('CLOUDS2', u)
		return (
			(u.prototype.defaultOptions = {
				backgroundColor: 0,
				skyColor: 6072010,
				cloudColor: 3362176,
				lightColor: 16777215,
