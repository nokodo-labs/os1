!(function (e, t) {
	...
	(() => {
		...
		n.VantaBase = class {
			...
			initThree() {
				s.WebGLRenderer
					? ((this.renderer = new s.WebGLRenderer({ alpha: !0, antialias: !0 })),
		...
		class l extends h {
			...
			initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
				...
				o && (this.uniforms.iTex = { type: 't', value: new a.TextureLoader().load(o) })
				const s = new a.Mesh(new a.PlaneGeometry(2, 2), i)
				;(this.scene.add(s), (this.camera = new a.Camera()), (this.camera.position.z = 1))
			}
			updateUniforms() {
				const e = {}
				let t, i
