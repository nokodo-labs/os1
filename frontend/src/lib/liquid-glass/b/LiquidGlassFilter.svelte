...
<svg width="0" height="0" style="position: absolute;" color-interpolation-filters="sRGB">
	<defs>
		<filter id={filterId} x="-5%" y="-5%" width="110%" height="110%">
			<!-- 1. blur the source (background behind the element) -->
			...
			<!-- 3. apply refraction displacement to the BLURRED source -->
			<feDisplacementMap
				in="blurred"
				in2="dispMap"
				scale={computedScale}
			...
			<feComposite in="tint" in2="refracted" operator="over" result="tinted" />
