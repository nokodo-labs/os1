...
>
	<div class="flex flex-col gap-5">
		<div class="flex items-center gap-4">
			...
			<input
				class="min-w-0 flex-1 rounded-full bg-white/8 px-4 py-3 text-sm text-white ring-1 ring-white/10 transition-all outline-none placeholder:text-white/30 focus:ring-(--accent-primary)/50"
				type="text"
