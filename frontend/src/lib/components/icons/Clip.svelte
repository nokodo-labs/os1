<script lang="ts">
	...
	// a paperclip is a bent wire with no body to fill, so this icon is outline-only and
	// takes no `variant`: a menu row that selects it asks for solid and gets this drawing.
	let {
