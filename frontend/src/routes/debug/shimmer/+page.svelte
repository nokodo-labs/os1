...
<div class="mx-auto w-full max-w-6xl px-6 pt-10 pb-24">
	...
	<div class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
		<section class="border-foreground/10 rounded-2xl border bg-black/20 p-5">
			<div class="flex items-center justify-between gap-3">
				<h2 class="text-base font-semibold">splash preview</h2>
				<div class="flex items-center gap-2">
					<button
						class="border-foreground/10 rounded-xl border bg-black/30 px-3 py-2 text-sm hover:bg-black/40"
