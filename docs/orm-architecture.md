...
-   deleting a thread terminates ALL attached tasks (UI shows warning: "all tasks from this Chat will be cancelled. do you want to continue?")
...
-   metadata (flexible JSON - role-specific fields)
...
-   varying structures based on role enable rich functionality
...
-   threads can have multiple owners (add user_ids array)
