...
async def get_current_branch(
	...
	return await thread_service.get_current_branch(chat_id, db)
...
async def get_message_tree(
	...
	return await thread_service.list_message_tree(chat_id, db)
...
async def add_message(
	...
	"""
	return await thread_service.create_message(chat_id, message_in, db)
...
async def switch_branch(
	...
	thread = await thread_service.switch_branch(chat_id, req.message_id, db)
