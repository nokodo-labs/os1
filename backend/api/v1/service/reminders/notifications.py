"""reminder notification scheduling and delivery helpers."""
...
@async_shared_broker.task(task_name="reminders.dispatch_notification")
async def dispatch_reminder_notification(reminder_id: TypeID) -> int:
	"""deliver due notifications for one reminder."""
	return await deliver_reminder_notification(reminder_id)
...
async def deliver_reminder_notification(reminder_id: TypeID) -> int:
