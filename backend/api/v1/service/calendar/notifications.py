"""calendar notification scheduling and delivery helpers."""
...
@async_shared_broker.task(task_name="calendar.dispatch_event_notification")
async def dispatch_calendar_event_notification(calendar_event_id: TypeID) -> int:
	"""deliver due notifications for one calendar event."""
	return await deliver_calendar_event_notification(calendar_event_id)
...
async def deliver_calendar_event_notification(calendar_event_id: TypeID) -> int:
