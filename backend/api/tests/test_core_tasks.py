"""tests for api.local_tasks - shared local background task utilities."""
...
from api.local_tasks import _background_tasks, _on_task_done, create_background_task
...
class TestCreateBackgroundTask:
	...
	async def test_task_exception_is_logged(self) -> None:
		...
		with patch("api.local_tasks.logger") as mock_logger:
