...
export const api = {
	async login(data: Body_login_access_token_auth_login_access_token_post): Promise<Token> {
		...
		if (data.client_secret) body.append('client_secret', data.client_secret)
	...
	async updateProvider(id: string, data: Partial<ProviderCreate>): Promise<Provider> {
