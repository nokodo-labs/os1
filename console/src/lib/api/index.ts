...
export type ReminderCreate = Schemas['ReminderCreate']
export type ReminderList = Schemas['ReminderList']
export type ReminderListCreate = Schemas['ReminderListCreate']
export type ReminderListUpdate = Schemas['ReminderListUpdate']
export type ReminderListWithCounts = Schemas['ReminderListWithCounts']
export type ReminderStatus = Schemas['ReminderStatus']
export type ReminderUpdate = Schemas['ReminderUpdate']
