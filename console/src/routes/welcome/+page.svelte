...
<div
	class="flex min-h-screen flex-col items-center justify-center bg-zinc-950 text-zinc-100"
>
	{#if step === "welcome"}
		<div class="max-w-md space-y-6 p-6 text-center">
			...
			<p class="text-zinc-400">
				it looks like this is a fresh installation. let's set up your
				admin account to get started.
			</p>
			<Button size="lg" onclick={() => (step = "register")}
